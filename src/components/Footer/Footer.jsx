...
const Footer = () => {
  ...
  const socialIcons = (
    <Row>
      <a
        href="https://www.Facebook.com/life-is-hope-106186367738715"
        target="_blank"
      ...
      <a
        href="https://www.instagram.com/lifeishope/"
        target="_blank"
        className={styles.icon}
      >
      ...
      <a
        href="https://Twitter.com/lifeishope"
        target="_blank"
        className={styles.icon}
      >
      ...
      <a
        href="https://www.youtube.com/channel/UCHIzsYjfHgWJ_8LFKHkADJA"
        target="_blank"
        className={styles.icon}
      >
